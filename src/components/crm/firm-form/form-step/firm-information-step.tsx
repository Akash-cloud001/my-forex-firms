...
function FilePreview({ file }: { file: File }) {
  ...
  if (!objectUrl) return <div className="text-xs text-muted-foreground">Loading...</div>;

  return <Image src={objectUrl} alt={file.name} className="w-full h-full object-cover" fill />;
}
...
export default function FirmInformationStep({ onNext, isFirstStep }: StepProps) {
  const { control, watch } = useFormContext();

  return (
    <div onKeyDown={preventEnterSubmit} className="space-y-8">
      <div>
                              ...
                              <div className="flex items-center space-x-2">
                                <div className="w-12 h-12 relative overflow-hidden bg-primary/10 rounded flex items-center justify-center">
                                  {field.value instanceof File ? (
                                    ...
                                    <Image src={watch("logoUrl")} alt="Logo" className="w-full h-full object-cover" fill />
                                  ) : null}
                                </div>
                                <div className="flex flex-col">
                                  <span className="text-sm font-medium truncate">
                                    {field.value instanceof File ? field.value.name : "Current Logo"}
                                  </span>
                                </div>
                              </div>
                              <Button
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Company registration or tax ID</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Country or state of registration</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>Information about company leadership and official channels</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Public leadership information</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="url" placeholder="https://linkedin.com/in/ceo-name" {...field} />
                    </FormControl>
                    <FormDescription>Public profiles (LinkedIn, Twitter, etc.)</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>TrustPilot rating (0-5 stars)</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>A concise overview of the firm (2-3 sentences)</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
