        ...
        <div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Customer support channels and status information
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <FormField
                  control={form.control}
                  name="statusTrustPageUrl"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Status / Trust Page URL</FormLabel>
                      <FormControl>
                        <Input
                          type="url"
                          placeholder="https://status.company.com"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>
                        Public status page or trust indicators
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Support Chat URL</FormLabel>
                      <FormControl>
                        <Input
                          type="url"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Support Hours / SLA</FormLabel>
                      <FormControl>
                        <Input
                          placeholder="24/7 or Mon-Fri 9AM-6PM EST"
                          {...field}
                        />
                      </FormControl>
                      <FormDescription>
