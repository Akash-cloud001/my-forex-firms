            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-6 text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-semibold">{firm.ceoFounderName ? firm.ceoFounderName : 'N/A'}</span>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-semibold">{firm.jurisdiction ? firm.jurisdiction : 'N/A'}</span>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-gray-300">Date Created:</span>
                  <span className="font-semibold">{formatDate(firm.createdAt) ? formatDate(firm.createdAt) : 'N/A'}</span>
                </div>
