...
const ReviewPageContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
      <div className="col-span-1">
        <div className="text-center flex flex-col items-center justify-center gap-4 lg:sticky lg:top-24">
          <Image
